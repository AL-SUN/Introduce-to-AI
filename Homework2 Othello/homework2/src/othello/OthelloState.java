...
public class OthelloState implements State {
	...
	public void printStabilitySumForBoard(){
		System.out.print("h:"+getStabilitySumForBoard(hBoard));
		System.out.print(" v:"+getStabilitySumForBoard(vBoard));
		System.out.print(" d1:"+getStabilitySumForBoard(dBoard1));
		System.out.print(" d2:"+getStabilitySumForBoard(dBoard2));
	}
	 ...
	 */
	public float stabilityDifferential() {
	 ...
	 */
	private float cornerValueDifferential() {
		float diff = 0;
