...
class GamePanel extends JPanel implements MouseListener {
	...
	long totalTime=0;//计时统计
	long maxTime=0;
	int moveCount=0;//步数统计
	...
	public void computerMove() {
		...
		do {
			...
			//Timer --long startTimeMillis = System.currentTimeMillis();
		...
		/*heuristic 分析
		System.out.println("heuristic:"+board.heuristic());
		System.out.println("stabilityDifferential:"+board.stabilityDifferential());
		board.printStabilitySumForBoard();*/
...
public class Othello extends JFrame {
	...
	public Othello(int whichPlayer, int nummilli, int maxDepth) {
		...
		*/
		...
		//gamePanel = new GamePanel(new MiniMaxDecider(computerIsMaximizer, maxDepth,false), start, computerMovesFirst);
		//gamePanel = new GamePanel(new MiniMaxDecider(computerIsMaximizer, maxDepth,true), start, computerMovesFirst);
