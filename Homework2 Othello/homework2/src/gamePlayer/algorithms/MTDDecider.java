...
public class MTDDecider implements Decider {
	 ...
	 */
	public MTDDecider(boolean maximizer, int searchTimeSec, int maxdepth, boolean usemtd) {
	...
	/**
	 * Helper to iteratively recurse down the search tree, getting deeper each time
	 * 
	 * @param root
